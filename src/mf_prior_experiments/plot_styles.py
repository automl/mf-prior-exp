...
ALGORITHMS = {
    ...
    "asha_hb_pb_mut_geom_dyna_bo_joint-default-at-target": "Mobster(+ESP)[joint]",
    "asha_hb_pb_mut_geom_dyna_bo_joint": "Mobster-PB-Mu+Dyn+G(j)",
    "asha_hb_pb_mut_geom_dyna_bo_rung-default-at-target": "Mobster(+ESP)",
    "asha_hb_pb_mut_geom_dyna_bo_rung": "Mobster-PB-Mu+Dyn+G",
    "asha_hb_pb_mut_geom_dyna-default-at-target": "Async-HB(+ESP)",
    ...
    "asha_pb_mut_geom_dyna-default-at-target": "ASHA(+ESP)",
