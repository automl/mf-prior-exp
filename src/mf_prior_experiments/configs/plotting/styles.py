...
Y_LIMITS: dict[str, tuple[float | None, float | None]] = {
     'cifar100_wideresnet_2048_prior-at25': (0.2, 0.3),
     'cifar100_wideresnet_2048_prior-bad': (0.2, 0.3),
     'cifar100_wideresnet_2048_prior-good': (0.2, 0.3),
     'cifar100_wideresnet_2048_prior-medium': (0.2, 0.3),
     'imagenet_resnet_512_prior-at25': (0.2, 0.3),
     'imagenet_resnet_512_prior-bad': (0.2, 0.3),
     'imagenet_resnet_512_prior-good': (0.2, 0.3),
     'imagenet_resnet_512_prior-medium': (0.2, 0.3),
     'jahs_cifar10_prior-at25': (8, 15),
     'jahs_cifar10_prior-bad': (8, 15),
     'jahs_cifar10_prior-good': (8, 15),
     'jahs_cifar10_prior-medium': (8, 15),
     'jahs_colorectal_histology_prior-at25': (4, 12),
     'jahs_colorectal_histology_prior-bad': (4, 12),
     'jahs_colorectal_histology_prior-good': (4, 12),
     'jahs_colorectal_histology_prior-medium': (4, 12),
     'jahs_fashion_mnist_prior-at25': (4, 8),
     'jahs_fashion_mnist_prior-bad': (4, 8),
     'jahs_fashion_mnist_prior-good': (4, 8),
     'jahs_fashion_mnist_prior-medium': (4, 8),
     'lcbench-126026_prior-at25': (0.025, 0.10),
     'lcbench-126026_prior-bad': (0.025, 0.10),
     'lcbench-126026_prior-good': (0.025, 0.10),
     'lcbench-126026_prior-medium': (0.025, 0.10),
     'lcbench-167190_prior-at25': (0.15, 0.3),
     'lcbench-167190_prior-bad': (0.15, 0.3),
     'lcbench-167190_prior-good': (0.15, 0.3),
     'lcbench-167190_prior-medium': (0.15, 0.3),
     'lcbench-168330_prior-at25': (0.3, 0.55),
     'lcbench-168330_prior-bad': (0.3, 0.55),
     'lcbench-168330_prior-good': (0.3, 0.55),
     'lcbench-168330_prior-medium': (0.3, 0.55),
     'lcbench-168910_prior-at25': (0.3, 0.5),
     'lcbench-168910_prior-bad': (0.3, 0.5),
     'lcbench-168910_prior-good': (0.3, 0.5),
     'lcbench-168910_prior-medium': (0.3, 0.5),
     'lcbench-189906_prior-at25': (0.1, 0.3),
     'lcbench-189906_prior-bad': (0.1, 0.3),
     'lcbench-189906_prior-good': (0.1, 0.3),
     'lcbench-189906_prior-medium': (0.1, 0.3),
     'lm1b_transformer_2048_prior-at25': (0.6, 0.7),
     'lm1b_transformer_2048_prior-bad': (0.6, 0.7),
     'lm1b_transformer_2048_prior-good': (0.6, 0.7),
     'lm1b_transformer_2048_prior-medium': (0.6, 0.7),
     ...
     'translatewmt_xformer_64_prior-at25': (0.33, 0.4),
     'translatewmt_xformer_64_prior-bad': (0.33, 0.4),
     'translatewmt_xformer_64_prior-good': (0.33, 0.4),
     'translatewmt_xformer_64_prior-medium': (0.33, 0.4),
}
