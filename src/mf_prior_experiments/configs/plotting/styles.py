...
ALGORITHMS = {
    ...
    "ours_v2": "V2",
    "raceband": "Raceband",
    "raceband_3iters": "Raceband",
    "raceband_5iters": "Raceband",
    "raceband_10iters": "Raceband",
    "raceband_10iters_default": "Raceband with default",
    "raceband_10iters_no_prior": "Raceband - no prior",
    "raceband_10iters_random": "Raceband - random sampling",
    "raceband_10iters_random_sparse": "PriorBand",
    "racebandv2": "RacebandV2",
    "raceband_no_local_promotion": "Raceband (no-local)",
    "raceband_no_local_anything": "Raceband (no-local)",
    "ours_v2_2": "V2_2",
    "ours_v2_3": "V2_3",
    "ours_v3": "V3",
    "ours_v3_2": "V3_2",
...
COLOR_MARKER_DICT = {
    ...
    "raceband_10iters_no_prior": "indigo",
    "raceband_no_local_promotion": "blue",
    "raceband_no_local_anything": "blue",
    "raceband_10iters_random": "seagreen",
