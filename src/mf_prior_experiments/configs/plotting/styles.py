...
ALGORITHMS = {
    ...
    "priorband_bo_linear": "PriorBand(linear)+BO",
    "priorband_crossover_constant": "PB(Cr+const.)",
    "priorband_crossover_constant_linear": "PB(Cr+const.+linear)",
    "priorband_crossover_decay": "PB(Cr+decay)",
    "priorband_crossover_decay_linear": "PB(Cr+decay+linear)",
    ...
    "priorband_hypersphere_constant_linear": "PB(HS+const.+linear)",
    "priorband_hypersphere_decay": "PB(HS+decay)",
    "priorband_hypersphere_decay_linear": "PB(HS+decay+linear)",
    "priorband_hypersphere_dynamic": "PB(HS+dyna)",
    "priorband_hypersphere_dynamic_linear": "PB(HS+dyna+linear)",
    ...
    "priorband_noprior_inc_cr_linear": "HB+inc(Cr+linear)",
    "priorband_noprior_inc_hs": "HB+inc(HS)",
    "priorband_noprior_inc_hs_linear": "HB+inc(HS+linear)",
}
...
COLOR_MARKER_DICT = {
    ...
    "priorband_noinc_prior_linear": "limegreen",
