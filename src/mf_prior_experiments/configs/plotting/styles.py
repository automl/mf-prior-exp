...
ALGORITHMS = {
    ...
    "hb_priorband_crossover": "PB (Cr)",
    "hb_priorband_hypersphere": "PB (HS)",
    "hb_priorband_custom": "PB (1/3)",
    "hb_priorband_dyna": "PB dyna",
    "hb_priorband_noinc_prior": "PB (inc as prior)",
    "hb_priorband_noinc_random": "PB (inc as RS)",
    "hb_priorband_noprior_random": "PB (prior as RS)",
    "hb_priorband_noprior_inc": "PB (prior as inc)",
    "hb_priorband_noprior_inc_hs": "HB + inc(HS)",
    "hb_priorband_noprior_inc_cr": "HB + inc(Cr)",
