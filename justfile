...
# Submit job
@submit algorithms benchmarks seeds="range(1)" experiment_group="test" job_name="default" partition="**removed**" max_tasks="1000" time="0-23:59" memory="0" n_worker="1":
